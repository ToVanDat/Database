...
namespace QuanLyThuVien
{
    public partial class Sach : Form
    {
        ...
        {
            string sSql1 = "select Author_ID from TacGia";
            ...
            string sSql3 = "select Type_ID from LoaiSach";
        ...
        {
            string query = "select * from Sach where Booktitle  like N'%" + txtTimSach.Text + "%'";
            mySqlCommand = new SqlCommand(query, mySqlconnection);
            mySqlCommand.ExecuteNonQuery();
            SqlDataReader dr = mySqlCommand.ExecuteReader();
            DataTable dt = new DataTable();
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query3 = "delete from Sach where Book_ID = '" + MaSach + "'";
            ...
            {
                MessageBox.Show("This book that is being borrowed by a student cannot be deleted.", "Notification");
            }
}
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            if (bien == 1)
            {
                if (txtMaSach.Text.Trim() == ""|| txtTenSach.Text.Trim() == "" || txtGiaBan.Text.Trim() == "" || txtSoLuong.Text.Trim() == "" || txtSoTrang.Text.Trim() == "")
                {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Please Re-enter as a positive number!", "Notification");
                        return;
                    }
                    for (int i = 0; i < dgvSach.RowCount; i++)
                    {
                        ...
                        {
                            MessageBox.Show("Duplicate book code. Please re-enter", "Notification");
                            return;
                        }
                    }
                    string query1 = "insert into Sach values(N'" + txtMaSach.Text + "',N'" + txtTenSach.Text + "',N'" + cbTacGia.Text + "', N'" + cbNhaXB.Text + "',N'" + cbLoaiSach.Text + "','" + txtSoTrang.Text + "', N'" + txtGiaBan.Text + "', N'" + txtSoLuong.Text + "')";
            ...
            {
                if ( txtTenSach.Text.Trim() == "" || txtGiaBan.Text.Trim() == "" || txtSoLuong.Text.Trim() == "" || txtSoTrang.Text.Trim() == "")
                {
                    MessageBox.Show("Please enter complete information!!!");
                    return;
                }
                else
                {
                    ...
                    int row = dgvSach.CurrentRow.Index;
                    string MaSach = dgvSach.Rows[row].Cells[0].Value.ToString();
                    string query2 = "update Sach set Booktitle  = N'" + txtTenSach.Text + "', Author_ID = N'" + cbTacGia.Text + "', Publishing_ID = N'" + cbNhaXB.Text + "',Type_ID  = '" + cbLoaiSach.Text + "',Page_Number  = '" + txtSoTrang.Text + "', Selling_Price  = N'" + txtGiaBan.Text + "', Quantity  = N'" + txtSoLuong.Text + "' where Book_ID = '" + MaSach+"'";
