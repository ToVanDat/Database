...
namespace QuanLyThuVien
{
    public partial class MuonTraSach : Form
    {
        ...
        {
            string sSql1 = "select Student_ID from SinhVien";
            ...
            string sSql2 = "select Book_ID from Sach";
            ...
            string sSql3 = "select CallCard from MuonTraSach";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query3 = "delete from MuonTraSach where CallCard = '" + MaPhieuMuon + "'";
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            if (bien == 1)
            {
                ...
                else
                {
                    ...
                    string query1 = "insert into PhieuMuon values(N'" + txtMaPhieu.Text + "','" + cbSV.Text + "',N'" + txtGhiChu.Text + "')";
            ...
            else
            {
                ...
                else
                {
                    ...
                    string query2 = "update PhieuMuon set StudentID = '" + cbSV.Text + "', Note = N'" + txtGhiChu.Text + "' where CallCard = '" + MaPhieu +"'";
        ...
        private void btnGhii_Click(object sender, EventArgs e)
        {
            if (bien == 5)
            {
                ...
                string sSql1 = "select Quantity  from Sach where Book_ID =" + MaSach + "";
                mySqlCommand = new SqlCommand(sSql1, mySqlconnection);
                mySqlCommand.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(mySqlCommand);
                ...
                if (SoLuongSach > 0)
                {
                    ...
                    if (SoNgay > 0)
                    {
                        ...
                        string query2 = "insert into MuonTraSach values(N'" + cbMaPhieuMuon.Text + "','" + cbMaSach.Text + "', GETDATE(),'" + cbNgayHenTra.Value + "','" + txtGhichuu.Text + "')";
                        mySqlCommand = new SqlCommand(query2, mySqlconnection);
                        mySqlCommand.ExecuteNonQuery();
                        SoLuongSauMuon();
                        DisMuonSach();
            ...
            else
            {
                int row = dgvMuonTra.CurrentRow.Index;
                string MaMuonTra = dgvMuonTra.Rows[row].Cells[0].Value.ToString();
                string query2 = "update MuonTraSach set CallCard = '" + cbMaPhieuMuon.Text + "', BookID = '" + cbMaSach.Text + "', BorrowedDate  = '" + cbNgayMuon.Value + "', PaymentDate  = '" + cbNgayHenTra.Value + "', Note = N'" + txtGhichuu.Text + "' where CallCard = " + MaMuonTra;
                mySqlCommand = new SqlCommand(query2, mySqlconnection);
                mySqlCommand.ExecuteNonQuery();
                DisMuonSach();
                SetControls(false);
        ...
        public void SoLuongSauMuon()// Hàm này để thay đổi số lượng sách khi mượn sách.
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                string query2 = "update Sach set Quantity = " + SoLuong + " where Book_ID = " + MaSach + "";
                mySqlCommand = new SqlCommand(query2, mySqlconnection);
                mySqlCommand.ExecuteNonQuery();
            }
        }
